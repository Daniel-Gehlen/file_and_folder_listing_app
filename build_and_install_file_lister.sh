...
VERSION="1.0"
ARCH="amd64"
PY_SCRIPT="file_lister.py"
ICON_URL="https://cdn-icons-png.flaticon.com/512/715/715676.png"  # ícone pasta
...
Depends: python3, libqt5widgets5
Description: Listador de Arquivos e Pastas
 Aplicativo para listar arquivos em diretórios e exportar resultados.
EOL
...
Version=$VERSION
Name=File Lister
GenericName=File and Folder Listing Tool
Comment=List and export directory contents
Exec=$APP_NAME
Icon=$APP_NAME
Terminal=false
Type=Application
Categories=Utility;
StartupWMClass=FileLister
EOL
...
echo "🔍 Ele aparecerá no menu com o nome 'File Lister'."
